...
def upgrade() -> None:
    ...
    # Unique constraint: un usuario no puede tener más de un turno abierto
    op.create_index(
        'idx_un_turno_abierto',
        'TURNOS_CAJA',
        ['usuario_id'],
        unique=True,
        postgresql_where=sa.text("fecha_hasta IS NULL")
    )
...
def downgrade() -> None:
    ...
    op.drop_index('idx_un_turno_abierto', table_name='TURNOS_CAJA')
